...
HD_PWD='D:/Dokumenty/AGH/SDUP/Projekt/fpga_censor/censor_axi/censor_axi.runs/mb_design_axi_gpio_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_axi_gpio_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_axi_gpio_0_2.tcl
