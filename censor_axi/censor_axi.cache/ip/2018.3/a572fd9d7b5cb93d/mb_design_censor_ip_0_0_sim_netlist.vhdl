...
\mask_bits[3]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"8"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating is
  port (
    ...
    \new_mask_reg[3]\ : in STD_LOGIC;
    \new_mask_reg[3]_0\ : in STD_LOGIC;
    \new_mask_reg[3]_1\ : in STD_LOGIC;
    is_bad_word_reg_i_1_0 : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_input_char_shift_reg is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \char_out[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \char_out[3]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \char_out[5]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of out_ready_i_2 : label is "soft_lutpair16";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller is
  port (
    \new_mask_reg[2]_0\ : out STD_LOGIC_VECTOR ( 0 to 0 );
    mask_out : out STD_LOGIC;
    new_mask10_in : in STD_LOGIC;
    is_bad_word : in STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 0 to 0 );
    \new_mask_reg[14]_0\ : in STD_LOGIC;
    \new_mask_reg[14]_1\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller is
  signal mask_bits : STD_LOGIC_VECTOR ( 14 downto 3 );
  ...
  signal new_mask : STD_LOGIC_VECTOR ( 14 downto 3 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \mask_bits[10]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \mask_bits[11]_i_1\ : label is "soft_lutpair21";
  attribute SOFT_HLUTNM of \mask_bits[12]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \mask_bits[13]_i_1\ : label is "soft_lutpair22";
  attribute SOFT_HLUTNM of \mask_bits[14]_i_1\ : label is "soft_lutpair23";
  attribute SOFT_HLUTNM of \mask_bits[4]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mask_bits[5]_i_1\ : label is "soft_lutpair18";
  attribute SOFT_HLUTNM of \mask_bits[6]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \mask_bits[7]_i_1\ : label is "soft_lutpair19";
  attribute SOFT_HLUTNM of \mask_bits[8]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of \mask_bits[9]_i_1\ : label is "soft_lutpair20";
  attribute SOFT_HLUTNM of mask_out_i_1 : label is "soft_lutpair23";
begin
...
\new_mask_reg[10]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[11]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[12]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[13]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[14]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[2]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[4]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[6]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[7]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
\new_mask_reg[8]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0'
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_word_length_counter is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \new_mask[10]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \new_mask[11]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \new_mask[12]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \new_mask[13]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \new_mask[14]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \new_mask[14]_i_2\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \new_mask[2]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \new_mask[3]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \new_mask[4]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \new_mask[5]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \new_mask[6]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \new_mask[7]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \new_mask[8]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \new_mask[8]_i_2\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \word_len[1]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of \word_len[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \word_len[3]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \word_len[4]_i_3\ : label is "soft_lutpair7";
begin
\new_mask[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AA89"
    )
        port map (
...
\new_mask[12]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F001"
    )
        port map (
...
\new_mask[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"E001"
    )
        port map (
...
\new_mask[14]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8081"
    )
        port map (
...
\new_mask[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"FB"
    )
        port map (
...
\new_mask[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFEFF"
    )
        port map (
...
\new_mask[4]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"AB"
    )
        port map (
...
\new_mask[5]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEEEB"
    )
        port map (
...
\new_mask[6]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"89"
    )
        port map (
...
\new_mask[7]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"81"
    )
        port map (
...
\new_mask[8]_i_2\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"01"
    )
        port map (
...
hash_rotating: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating
     port map (
      ...
      \new_mask_reg[3]\ => hash_bernstein_n_6,
      \new_mask_reg[3]_0\ => hash_bernstein_n_7,
      \new_mask_reg[3]_1\ => hash_bernstein_n_5
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_censor_main is
  ...
  signal new_mask : STD_LOGIC_VECTOR ( 2 to 2 );
...
bloom_table_control: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bloom_table_control
     port map (
      ...
      hash_ready_rotating => hash_ready_rotating,
      is_bad_word => is_bad_word,
      new_mask(0) => new_mask(2),
      \new_mask_reg[3]\ => hashing_n_1
    );
hashing: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hashing
     port map (
      ...
      new_mask10_in => new_mask10_in,
      \word_len_reg[1]\ => hashing_n_3,
      \word_len_reg[1]_0\ => hashing_n_5,
      \word_len_reg[1]_1\ => hashing_n_7,
      \word_len_reg[1]_2\ => hashing_n_14,
      \word_len_reg[1]_3\ => hashing_n_15,
      \word_len_reg[2]\ => hashing_n_2,
      \word_len_reg[2]_0\ => hashing_n_6,
      \word_len_reg[2]_1\ => hashing_n_8,
      \word_len_reg[3]\ => hashing_n_9,
      \word_len_reg[3]_0\ => hashing_n_10,
      \word_len_reg[3]_1\ => hashing_n_12,
      \word_len_reg[4]\ => hashing_n_11,
...
mask_controller: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller
     port map (
      ...
      mask_out => mask_out,
      new_mask10_in => new_mask10_in,
      \new_mask_reg[10]_0\ => hashing_n_12,
      \new_mask_reg[11]_0\ => hashing_n_3,
      \new_mask_reg[12]_0\ => hashing_n_5,
      \new_mask_reg[13]_0\ => hashing_n_7,
      \new_mask_reg[14]_0\ => hashing_n_13,
      \new_mask_reg[14]_1\ => hashing_n_9,
      \new_mask_reg[2]_0\(0) => new_mask(2),
      \new_mask_reg[2]_1\ => hashing_n_15,
      \new_mask_reg[4]_0\ => hashing_n_6,
      \new_mask_reg[5]_0\ => hashing_n_10,
      \new_mask_reg[6]_0\ => hashing_n_8,
      \new_mask_reg[7]_0\ => hashing_n_2,
      \new_mask_reg[8]_0\ => hashing_n_14,
