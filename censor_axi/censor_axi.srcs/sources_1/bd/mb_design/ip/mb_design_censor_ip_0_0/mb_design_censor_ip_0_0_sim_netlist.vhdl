...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_input_char_shift_reg is
  port (
...
architecture STRUCTURE of mb_design_censor_ip_0_0_input_char_shift_reg is
  ...
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \char_out[1]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \char_out[3]_i_1\ : label is "soft_lutpair16";
  attribute SOFT_HLUTNM of \char_out[5]_i_1\ : label is "soft_lutpair15";
  attribute SOFT_HLUTNM of out_ready_i_2 : label is "soft_lutpair15";
begin
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_mask_controller is
  port (
...
architecture STRUCTURE of mb_design_censor_ip_0_0_mask_controller is
  ...
  signal flag_set_i_1_n_0 : STD_LOGIC;
  signal flag_used : STD_LOGIC;
  ...
  signal \mask_bits[2]_i_1_n_0\ : STD_LOGIC;
  ...
  signal new_mask : STD_LOGIC_VECTOR ( 14 downto 1 );
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of \mask_bits[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \mask_bits[9]_i_1\ : label is "soft_lutpair17";
begin
flag_set_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
flag_set_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
flag_used_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\mask_bits[10]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[11]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[12]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[13]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[2]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"60"
    )
        port map (
      ...
      I1 => flag_used,
      I2 => new_mask(1),
      O => \mask_bits[2]_i_1_n_0\
    );
\mask_bits[3]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[4]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[8]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
\mask_bits[9]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
mask_out_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AEEA"
    )
        port map (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_out_char_select is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_word_length_counter is
  port (
    ...
    \word_len_reg[0]_1\ : out STD_LOGIC;
    \word_len_reg[3]_3\ : out STD_LOGIC;
    \word_len_reg[3]_4\ : out STD_LOGIC;
...
architecture STRUCTURE of mb_design_censor_ip_0_0_word_length_counter is
  ...
  attribute SOFT_HLUTNM of \new_mask[11]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \new_mask[12]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \new_mask[13]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \new_mask[14]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \new_mask[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \new_mask[2]_i_1\ : label is "soft_lutpair12";
  attribute SOFT_HLUTNM of \new_mask[3]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \new_mask[4]_i_1\ : label is "soft_lutpair14";
  attribute SOFT_HLUTNM of \new_mask[5]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \new_mask[6]_i_1\ : label is "soft_lutpair11";
  attribute SOFT_HLUTNM of \new_mask[7]_i_1\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \new_mask[9]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \word_len[2]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \word_len[3]_i_1\ : label is "soft_lutpair13";
  attribute SOFT_HLUTNM of \word_len[4]_i_3\ : label is "soft_lutpair9";
begin
...
\new_mask[11]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAF8F8F8"
    )
        port map (
...
\new_mask[12]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EC"
    )
        port map (
...
\new_mask[13]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFE0FF00"
    )
        port map (
...
\new_mask[14]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F8F0"
    )
        port map (
...
\new_mask[1]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFFFFE"
    )
        port map (
...
\new_mask[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFE"
    )
        port map (
...
\new_mask[6]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFF8"
    )
        port map (
...
\new_mask[7]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFFEAAA"
    )
        port map (
...
\new_mask[8]_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\new_mask[9]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAFAFAF8"
    )
        port map (
...
word_length_counter: entity work.mb_design_censor_ip_0_0_word_length_counter
     port map (
      ...
      \word_len_reg[0]_1\ => \word_len_reg[0]_0\,
      ...
      \word_len_reg[3]_4\ => \word_len_reg[3]_3\,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_censor_main is
  port (
    out_ready : out STD_LOGIC;
    D : out STD_LOGIC_VECTOR ( 7 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_censor_ip_v1_0_S00_AXI is
  port (
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0_censor_ip_v1_0 is
  port (
    S_AXI_AWREADY : out STD_LOGIC;
    S_AXI_WREADY : out STD_LOGIC;
    S_AXI_ARREADY : out STD_LOGIC;
...
begin
censor_ip_v1_0_S00_AXI_inst: entity work.mb_design_censor_ip_0_0_censor_ip_v1_0_S00_AXI
     port map (
      S_AXI_ARREADY => S_AXI_ARREADY,
      S_AXI_AWREADY => S_AXI_AWREADY,
      S_AXI_WREADY => S_AXI_WREADY,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity mb_design_censor_ip_0_0 is
  port (
  ...
  attribute NotValidForBitStream of mb_design_censor_ip_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of mb_design_censor_ip_0_0 : entity is "mb_design_censor_ip_0_0,censor_ip_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of mb_design_censor_ip_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of mb_design_censor_ip_0_0 : entity is "censor_ip_v1_0,Vivado 2018.3";
end mb_design_censor_ip_0_0;

architecture STRUCTURE of mb_design_censor_ip_0_0 is
...
inst: entity work.mb_design_censor_ip_0_0_censor_ip_v1_0
     port map (
