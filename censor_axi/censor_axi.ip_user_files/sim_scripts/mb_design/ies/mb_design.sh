...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../censor_axi.srcs/sources_1/bd/mb_design/ipshared/85a3" \
       +incdir+"$ref_dir/../../../../censor_axi.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl" \
       +incdir+"../../../../censor_axi.srcs/sources_1/bd/mb_design/ipshared/85a3" \
       +incdir+"../../../../censor_axi.srcs/sources_1/bd/mb_design/ipshared/ec67/hdl"
}
