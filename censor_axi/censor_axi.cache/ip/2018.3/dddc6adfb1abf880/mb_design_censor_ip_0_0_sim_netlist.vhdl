...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bloom_table_control is
  port (
    ...
    \new_mask_available_reg__0\ : in STD_LOGIC;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating is
  port (
    ...
    \new_mask_available_reg__0\ : in STD_LOGIC;
    \new_mask_available_reg__0_0\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller is
  signal new_mask_available : STD_LOGIC;
begin
mask_out_reg: unisim.vcomponents.FDRE
    generic map(
      ...
      C => Q(0),
      CE => '1',
      D => new_mask_available,
      Q => mask_out,
      R => '0'
    );
new_mask_available_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
      ...
      CE => '1',
      D => '0',
      Q => new_mask_available,
      R => '0'
    );
\new_mask_available_reg__0\: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
...
hash_rotating: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating
     port map (
      ...
      \new_mask_available_reg__0\ => hash_bernstein_n_10,
      \new_mask_available_reg__0_0\ => hash_bernstein_n_16
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
bloom_table_control: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bloom_table_control
     port map (
      ...
      \new_mask_available_reg__0\ => hashing_n_1
    );
