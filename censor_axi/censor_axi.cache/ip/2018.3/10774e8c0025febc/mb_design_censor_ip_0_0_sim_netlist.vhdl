...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_bloom_table_control is
  ...
  signal is_bad_word_reg_i_1_n_0 : STD_LOGIC;
...
is_bad_word_reg: unisim.vcomponents.LDCE
    generic map(
      INIT => '0'
        ...
        port map (
      CLR => '0',
      D => is_bad_word_reg_i_1_n_0,
      G => hash_ready_rotating,
      GE => '1',
      Q => \^is_bad_word\
    );
is_bad_word_reg_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => \^is_bad_word\,
      O => is_bad_word_reg_i_1_n_0
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_bernstein is
  port (
    ...
    hash_ready_reg_0 : in STD_LOGIC_VECTOR ( 6 downto 0 )
  );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_bernstein is
  ...
  signal hash_ready_i_2_n_0 : STD_LOGIC;
begin
hash_ready_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"EF"
    )
        port map (
      I0 => hash_ready_reg_0(6),
      I1 => hash_ready_i_2_n_0,
      I2 => Q(0),
      O => hash_ready_i_1_n_0
    );
hash_ready_i_2: unisim.vcomponents.LUT6
    generic map(
      INIT => X"A8A00001FFFFFFFF"
    )
        port map (
      I0 => hash_ready_reg_0(4),
      I1 => hash_ready_reg_0(1),
      I2 => hash_ready_reg_0(2),
      I3 => hash_ready_reg_0(0),
      I4 => hash_ready_reg_0(3),
      I5 => hash_ready_reg_0(5),
      O => hash_ready_i_2_n_0
    );
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_input_char_shift_reg is
  ...
  attribute SOFT_HLUTNM of \char_out[1]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \char_out[3]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \char_out[5]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of out_ready_i_2 : label is "soft_lutpair0";
begin
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hashing is
  port (
    hash_ready_rotating : out STD_LOGIC;
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
    hash_ready_reg : in STD_LOGIC_VECTOR ( 6 downto 0 )
  );
...
hash_bernstein: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_bernstein
     port map (
      ...
      hash_ready_reg_0(6 downto 0) => hash_ready_reg(6 downto 0),
...
hashing: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hashing
     port map (
      Q(1 downto 0) => Q(1 downto 0),
      hash_ready_reg(6 downto 5) => \char_buffer_reg[0][7]\(7 downto 6),
      hash_ready_reg(4 downto 0) => \char_buffer_reg[0][7]\(4 downto 0),
      hash_ready_rotating => hash_ready_rotating
    );
