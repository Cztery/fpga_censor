...
proc create_root_design { parentCell } {
  ...
  # Create instance: censor_ip_0, and set properties
  set censor_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:censor_ip:1.0 censor_ip_0 ]
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_1_locked [get_bd_pins rst_clk_wiz_1_100M/dcm_locked]
  connect_bd_net -net mdm_1_debug_sys_rst [get_bd_pins mdm_1/Debug_SYS_Rst] [get_bd_pins rst_clk_wiz_1_100M/mb_debug_sys_rst]
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_uart16550_0/s_axi_aclk] [get_bd_pins censor_ip_0/s00_axi_aclk] [get_bd_pins clk_wiz_1/clk_out1] [get_bd_pins gpio_char_in_0/s_axi_aclk] [get_bd_pins gpio_char_out_0/s_axi_aclk] [get_bd_pins gpio_in_ready_0/s_axi_aclk] [get_bd_pins gpio_out_ready_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/M02_ACLK] [get_bd_pins microblaze_0_axi_periph/M03_ACLK] [get_bd_pins microblaze_0_axi_periph/M04_ACLK] [get_bd_pins microblaze_0_axi_periph/M05_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins rst_clk_wiz_1_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_uart16550_0/s_axi_aresetn] [get_bd_pins censor_ip_0/s00_axi_aresetn] [get_bd_pins gpio_char_in_0/s_axi_aresetn] [get_bd_pins gpio_char_out_0/s_axi_aresetn] [get_bd_pins gpio_in_ready_0/s_axi_aresetn] [get_bd_pins gpio_out_ready_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/M02_ARESETN] [get_bd_pins microblaze_0_axi_periph/M03_ARESETN] [get_bd_pins microblaze_0_axi_periph/M04_ARESETN] [get_bd_pins microblaze_0_axi_periph/M05_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_char_in_0/S_AXI/Reg] SEG_gpio_char_in_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40010000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_char_out_0/S_AXI/Reg] SEG_gpio_char_out_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40020000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_in_ready_0/S_AXI/Reg] SEG_gpio_in_ready_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40030000 [get_bd_addr_spaces microblaze_0/Data] [get_bd_addr_segs gpio_out_ready_0/S_AXI/Reg] SEG_gpio_out_ready_0_Reg
