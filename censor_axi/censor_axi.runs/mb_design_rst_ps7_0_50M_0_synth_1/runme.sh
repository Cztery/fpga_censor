...
HD_PWD='D:/Dokumenty/AGH/SDUP/Projekt/drugi projekt/fpga_censor/censor_axi/censor_axi.runs/mb_design_rst_ps7_0_50M_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mb_design_rst_ps7_0_50M_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mb_design_rst_ps7_0_50M_0.tcl
