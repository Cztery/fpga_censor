...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_out_char_select is
  port (
    ...
    \char_out_reg[7]_0\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
...
\char_out_reg[7]\: unisim.vcomponents.FDRE
    generic map(
      ...
      CE => '1',
      D => D(7),
      Q => \char_out_reg[7]_0\(7),
      R => '0'
    );
out_ready_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FFFEFFFF"
    )
        port map (
      ...
      I2 => D(2),
      I3 => D(3),
      I4 => out_ready_i_2_n_0,
      O => out_ready_next
    );
out_ready_i_2: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0001"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_censor_main is
  port (
    out_ready : out STD_LOGIC;
    \char_out_reg[7]\ : out STD_LOGIC_VECTOR ( 7 downto 0 );
    Q : in STD_LOGIC_VECTOR ( 1 downto 0 );
...
input_char_buffer: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_input_char_shift_reg
     port map (
      D(7 downto 0) => \char_buffer_reg[15]\(7 downto 0),
...
out_char_select: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_out_char_select
     port map (
      D(7 downto 0) => \char_buffer_reg[15]\(7 downto 0),
      Q(0) => Q(1),
      \char_out_reg[7]_0\(7 downto 0) => \char_out_reg[7]\(7 downto 0),
      out_ready => out_ready
    );
end STRUCTURE;
library IEEE;
...
censor_main_inst: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_censor_main
     port map (
      ...
      \char_out_reg[7]\(7 downto 0) => char_out(7 downto 0),
      out_ready => out_ready
    );
