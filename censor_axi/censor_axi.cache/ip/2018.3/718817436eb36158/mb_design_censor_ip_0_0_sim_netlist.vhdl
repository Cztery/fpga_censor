...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating is
  port (
    ...
    \mask_bits_reg[3]\ : in STD_LOGIC;
    \mask_bits_reg[3]_0\ : in STD_LOGIC;
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller is
  signal mask_bits : STD_LOGIC_VECTOR ( 7 downto 3 );
  signal \mask_bits_reg[14]_srl7_n_0\ : STD_LOGIC;
  attribute srl_bus_name : string;
  attribute srl_bus_name of \mask_bits_reg[14]_srl7\ : label is "\inst/censor_ip_v1_0_S00_AXI_inst/censor_main_inst/mask_controller/mask_bits_reg ";
  attribute srl_name : string;
  attribute srl_name of \mask_bits_reg[14]_srl7\ : label is "\inst/censor_ip_v1_0_S00_AXI_inst/censor_main_inst/mask_controller/mask_bits_reg[14]_srl7 ";
begin
\mask_bits_reg[14]_srl7\: unisim.vcomponents.SRL16E
    generic map(
      INIT => X"0000",
      IS_CLK_INVERTED => '1'
    )
...
\mask_bits_reg[4]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\mask_bits_reg[5]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\mask_bits_reg[6]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
\mask_bits_reg[7]\: unisim.vcomponents.FDSE
    generic map(
      INIT => '0',
      IS_C_INVERTED => '1'
    )
...
hash_rotating: entity work.decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_hash_rotating
     port map (
      ...
      \mask_bits_reg[3]\ => hash_bernstein_n_10,
      \mask_bits_reg[3]_0\ => hash_bernstein_n_16
    );
end STRUCTURE;
library IEEE;
use IEEE.STD_LOGIC_1164.ALL;
