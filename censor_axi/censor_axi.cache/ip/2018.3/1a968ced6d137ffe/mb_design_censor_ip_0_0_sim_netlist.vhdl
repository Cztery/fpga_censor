...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_mask_controller is
  signal \mask_bits_reg[15]_srl16_n_0\ : STD_LOGIC;
  attribute srl_bus_name : string;
  attribute srl_bus_name of \mask_bits_reg[15]_srl16\ : label is "\inst/censor_ip_v1_0_S00_AXI_inst/censor_main_inst/mask_controller/mask_bits_reg ";
  attribute srl_name : string;
  attribute srl_name of \mask_bits_reg[15]_srl16\ : label is "\inst/censor_ip_v1_0_S00_AXI_inst/censor_main_inst/mask_controller/mask_bits_reg[15]_srl16 ";
begin
\mask_bits_reg[15]_srl16\: unisim.vcomponents.SRL16E
    generic map(
      INIT => X"E3FF"
    )
        port map (
